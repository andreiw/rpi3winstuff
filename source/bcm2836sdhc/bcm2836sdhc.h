...
Abstract:
    ...
    Header for BCM 2836 Arasan host controller implementation.
...
//
// Stall times (in microseconds)
//

#define SDHC_STALL_AFTER_SEND_CMD_US        200
#define SDHC_STALL_AFTER_REC_RESP_US        50
#define SDHC_STALL_AFTER_WRITE_US           200
#define SDHC_STALL_AFTER_READ_US            20

//
// Memory registers
// For the BCM 2836, registers can only be accessed at a DWORD alignment,
// so many standard 1-byte and 2-byte SD registers are combined into one.
//

#define SDHC_SYSADDR                        0x00
#define SDHC_BLOCK_SIZE_COUNT               0x04
#define SDHC_ARGUMENT                       0x08
#define SDHC_TRANSFER_MODE_COMMAND          0x0c
#define SDHC_RESPONSE_0                     0x10
#define SDHC_RESPONSE_1                     0x14
#define SDHC_RESPONSE_2                     0x18
#define SDHC_RESPONSE_3                     0x1c
#define SDHC_DATA_PORT                      0x20
#define SDHC_PRESENT_STATE                  0x24

//
// SDHC_HOST_CONTROL, SDHC_POWER_CONTROL, SDHC_BLOCKGAP_CONTROL, SDHC_WAKEUP_CONTROL
//

#define SDHC_CONTROL_0                      0x28

//
// SDHC_CLOCK_CONTROL, SDHC_TIMEOUT_CONTROL, SDHC_RESET
//

#define SDHC_CONTROL_1                      0x2c

#define SDHC_INTERRUPT_ERROR_STATUS         0x30
#define SDHC_INTERRUPT_ERROR_STATUS_ENABLE  0x34
#define SDHC_INTERRUPT_ERROR_SIGNAL_ENABLE  0x38

//
// SDHC_AUTO_CMD12_ERROR_STATUS, SDHC_HOST_CONTROL2
//

#define SDHC_CONTROL_2                      0x3c
...
#define SDHC_SLOT_INFORMATION_VERSION       0xfc

//
// Bits defined in SDHC_TRANSFER_MODE_COMMAND
//
...
#define SDHC_CMD_RESPONSE_136BIT            0x00010000
#define SDHC_CMD_RESPONSE_48BIT_NOBUSY      0x00020000
#define SDHC_CMD_RESPONSE_48BIT_WBUSY       0x00030000

#define SDHC_CMD_CRC_CHECK_ENABLE           0x00080000
#define SDHC_CMD_INDEX_CHECK_ENABLE         0x00100000
#define SDHC_CMD_DATA_PRESENT               0x00200000

#define SDHC_CMD_TYPE_SUSPEND               0x00400000
#define SDHC_CMD_TYPE_RESUME                0x00800000
#define SDHC_CMD_TYPE_ABORT                 0x00600000
...
//
// Bits defined in SDHC_CONTROL_0
//
...
#define SDHC_PC_BUS_POWER                   0x0100
#define SDHC_PC_1_8V                        0x0a00
#define SDHC_PC_3_0V                        0x0c00
#define SDHC_PC_3_3V                        0x0e00

#define SDHC_PC_VOLTAGE_MASK                0x0e00

//
// SDHC_BLOCKGAP_CONTROL
//

#define SDHC_BGC_STOP_NEXT_GAP              0x010000
#define SDHC_BGC_CONTINUE                   0x020000
#define SDHC_BGC_READ_WAIT_ENABLE           0x040000
#define SDHC_BGC_INTERRUPT_ENABLE           0x080000

//
// SDHC_WAKEUP_CONTROL
//

#define SDHC_WC_CARD_INT_ENABLE             0x01000000
#define SDHC_WC_CARD_INSERTION_ENABLE       0x02000000
#define SDHC_WC_CARD_REMOVAL_ENABLE         0x04000000
#define SDHC_WC_CARD_SUPPORTS_WAKEUP        0x80000000

//
// Bits defined in SDHC_CONTROL_1
//
...
#define SDHC_TC_COUNTER_MASK                0x0f0000
#define SDHC_TC_MAX_DATA_TIMEOUT            0x0e0000

//
// SDHC_RESET
//

#define SDHC_RESET_ALL                      0x01000000
#define SDHC_RESET_CMD                      0x02000000
#define SDHC_RESET_DAT                      0x04000000
...
#define SDHC_ALL_EVENTS                     (SDHC_IS_COMMAND_EVENT      | \
                                             SDHC_IS_CARD_INSERTION     | \
                                             SDHC_IS_CARD_REMOVAL       | \
                                             SDHC_IS_CARD_INTERRUPT     | \
                                             SDHC_IS_TUNING_INTERRUPT   | \
                                             SDHC_IS_ERROR_INTERRUPT    | \
                                             SDHC_ERROR_EVENTS)
...
//
// Bits defined in SDHC_CONTROL_2
//
...
#define SDHC_HC2_SDR12                      0x00000000
#define SDHC_HC2_SDR25                      0x00010000
#define SDHC_HC2_SDR50                      0x00020000
#define SDHC_HC2_SDR104                     0x00030000
#define SDHC_HC2_DDR50                      0x00040000
#define SDHC_HC2_HS200                      0x00050000
...
#define SDHC_HC2_1_8V_SIGNALING             0x00080000

#define SDHC_HC2_SELECT_TYPE_B              0x00000000
#define SDHC_HC2_SELECT_TYPE_A              0x00100000
#define SDHC_HC2_SELECT_TYPE_C              0x00200000
#define SDHC_HC2_SELECT_TYPE_D              0x00300000

#define SDHC_HC2_EXECUTE_TUNING             0x00400000
#define SDHC_HC2_SELECT_SAMPLING_CLOCK      0x00800000
#define SDHC_HC2_ENABLE_ASYNC_INTERRUPT     0x40000000
#define SDHC_HC2_ENABLE_PRESET_VALUE        0x80000000
...
#define SDHC_REG_LOWER_HALF_MASK            0x0000FFFF
#define SDHC_REG_UPPER_HALF_MASK            0xFFFF0000
#define SDHC_REG_SHIFT_UPPER_HALF_TO_LOWER  16
...
typedef struct _SDHC_EXTENSION {
    ...
    //
    // Whether the driver is in crashdump mode.
    //
...
NTSTATUS
SdhcSetVoltage (
    _In_ const SDHC_EXTENSION* SdhcExtension,
...
SdhcSetSignaling (
    _In_ const SDHC_EXTENSION* SdhcExtension,
    _In_ SDPORT_SIGNALING_VOLTAGE SignalingVoltage
    );
...
SdhcGetResponseLength (
    _In_ const SDPORT_COMMAND* Command
    );
